...
- **桁(けた)表示ボード**：4 枚
  <div class="img-container">
    <img src="{{site.baseurl}}/assets/img/kakakuhyouji.png" alt="桁表示ボード" onclick="openModal(this.src)">
  </div>
...
- **桁カード**：48 枚
  - ０カード：35 枚
    <div class="img-container">
      <img src="{{site.baseurl}}/assets/img/0カード.png" alt="０カード">
      <img src="{{site.baseurl}}/assets/img/otp_ketacard_ura.png" alt="０カードうら">
    </div>
  - ００カード：9 枚
    <div class="img-container">
      <img src="{{site.baseurl}}/assets/img/00カード.png" alt="００カード">
      <img src="{{site.baseurl}}/assets/img/otp_ketacard_ura.png" alt="００カードうら">
    </div>
  - ０００カード：4 枚
    <div class="img-container">
      <img src="{{site.baseurl}}/assets/img/000カード.png" alt="０００カード">
      <img src="{{site.baseurl}}/assets/img/otp_ketacard_ura.png" alt="０００カードうら">
    </div>
- **マーカーペン**：6 本
...
- **５．回答カード、予想カード、マーカーペンを各自 1 つずつ受け取ります。**
