...
- **桁(けた)表示ボード**：4 枚
  <div class="img-container">
    <img src="{{site.baseurl}}/assets/img/桁ボード.png" alt="桁ボード"  width="100%" height="100%" onclick="openModal(this.src)">
  </div>
...
- **桁カード**：48 枚
  ...
  - ０００カード：4 枚
<div class="img-container">
      <img src="{{site.baseurl}}/assets/img/0.00.000カード.png" alt="0.00.000カード">
    </div>
- **マーカーペン**：6 本
...
4. ボードの上限を超える位の予想も可能です。位は関係なく、上限を超えた場合に的中となります。
...
- 【鑑定失敗】価格決定カードの置かれた位より大きい位に予想していた場合、鑑定失敗です。  
 ...
 - 下の位からのくり上がりが発生する場合、×の上に勝利点を書きます。
  ...
  <div class="img-container">
    <img src="{{site.baseurl}}/assets/img/繰り上がり‗前.png" alt="くりあがる前">
  </div>
  <div class="img-container">
    <img src="{{site.baseurl}}/assets/img/繰り上がり‗後.png" alt="×の上に勝利点">
  </div>
